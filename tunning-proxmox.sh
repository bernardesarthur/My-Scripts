...
echo
apt install sudo lsof snapd vim tcptraceroute bash-completion build-essential irqbalance grc tree bmon net-tools nmap dnsutils whois htop curl wget apt-transport-https dirmngr mtr traceroute screenfetch iotop openssh-server netdiscover gnupg2 gnupg1 aptitude hping3 fping lshw unzip lsb-release ipcalc man-db hdparm fzf chrony whiptail -y
sleep 1; echo

echo "[3/8] Configurando serviços..."
echo
systemctl enable --now irqbalance snapd chrony
sleep 1; echo
